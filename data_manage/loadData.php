...
// 				 'SPAIN' => array('PRIMERA+DIVISION'));
	...
	$leagues = array('CZECH+REPUBLIC' => array('DIVISION+1'));

	foreach ($seasons as $season) {

		$seasonName = str_replace("%2F", "-", $season);
		$url = "http://www.xscores.com/soccer/Results.jsp?sport=1&countryName=DENMARK&leagueName=SUPERLIGAEN&seasonName=$season&sortBy=R&result=3#.UvjQvkKSztk";
		// echo "$url";
		...
		for ($j = 0; $j < $roundCount; $j ++) {
			...
			$url = "http://www.xscores.com/soccer/Results.jsp?sport=1&countryName=DENMARK&leagueName=SUPERLIGAEN&seasonName=$season&sortBy=R&round=$n&result=3#.UvjQ30KSztk";
			echo "$url<br>";
