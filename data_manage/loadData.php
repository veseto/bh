...
// 				 'SPAIN' => array('PRIMERA+DIVISION'));
	...
	foreach ($seasons as $season) {
		...
		$url = "http://www.xscores.com/soccer/Results.jsp?sport=1&countryName=USA&leagueName=MAJOR+LEAGUE+SOCCER&leagueName1=MAJOR+LEAGUE+SOCCER&seasonName=2013%2F2014&sortBy=R&result=3";
		//$url = "http://www.xscores.com/soccer/Results.jsp?sport=1&countryName=USA&leagueName=ALL+STAR+GAME.1&seasonName=$season&sortBy=R&result=3#.UvjQvkKSztk";
		echo "$url";
		...
		$firstRound = 114394;//$select->firstChild->getAttribute('value');
		$roundCount = 8;//$select->lastChild->nodeValue;
		...
		for ($j = 0; $j < $roundCount; $j ++) {
			...
			$url = "http://www.xscores.com/soccer/Results.jsp?sport=1&countryName=USA&leagueName=MAJOR+LEAGUE+SOCCER&leagueName1=MAJOR+LEAGUE+SOCCER&seasonName=2013%2F2014&sortBy=R&round=$n&result=3";
