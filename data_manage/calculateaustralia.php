...
// 	$mysqli -> query("INSERT INTO series (team, length, active, leagueId) values ('AUSTRALIA', 1, 1, 17)");

// 	$q = "SELECT * from matches where leagueId=17 and season='2013-2014' and state<>'Post' order by matchDate asc, matchTime asc";
// 	$mRes = $mysqli->query($q);
// 	$previousHasResult=False;
// 	while ($match = $mRes->fetch_assoc()) {
// 		$seriesId = $mysqli->query("select seriesId from series where team='AUSTRALIA' and active=1")->fetch_array()[0];
